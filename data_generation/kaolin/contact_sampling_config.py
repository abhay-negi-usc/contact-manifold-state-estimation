CONFIG = {
  "paths": {
      "static_mesh":"./data_generation/assets/meshes/cylinder_keyway02/cylinder_keyway02_hole.obj",
      "moving_mesh":"./data_generation/assets/meshes/cylinder_keyway02/cylinder_keyway02_peg.obj",
      "csv_out":"./data_generation/data/cylinder_keyway02/cylinder_keyway02_contact_poses.csv",
      "npz_out":"./data_generation/data/cylinder_keyway02/cylinder_keyway02_contact_poses.npz"
    },
  "device":"cuda",
  "seed":0,
  "bounds":{"tmin":[-0.001,-0.001,0.0],"tmax":[0.001,0.001,0.025],"rmin":[-5,-5,-5],"rmax":[5,5,5]}, # rmin/rmax in degrees
    # ------------------------------------------------------------
